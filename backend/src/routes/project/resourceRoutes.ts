...
r.post('/',      requirePermission('project:create'), validate(createResourceSchema), ctrl.create);
r.put('/:id',    requirePermission('project:create'), validate(updateResourceSchema), ctrl.update);
