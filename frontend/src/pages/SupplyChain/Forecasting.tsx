    ...
    <div className="space-y-6">
      ...
      {result && (
        <>
          ...
          {/* AI recommendation — plain-English explanation from Claude (optional) */}
          {result.insight && (
            <div className="rounded-xl p-5 border border-teal-800 bg-teal-950/30">
              <div className="flex items-start gap-3">
                <div className="text-xl leading-none mt-0.5">✨</div>
                <div>
                  <h3 className="font-semibold text-teal-200">AI recommendation</h3>
                  <p className="text-gray-200 text-sm mt-1 leading-relaxed">{result.insight}</p>
                  <p className="text-gray-500 text-xs mt-2">Generated by Claude from the forecast above — verify before acting.</p>
                </div>
              </div>
            </div>
          )}
